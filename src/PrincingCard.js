...
const PricingCard = () =>{
  ...
  <div className="pricing-plan">
    ...
    <ul>
      <li><i className="fa fa-check-circle"></i>  1 Live access</li>
      <hr className="line-in" />
      <li><i className="fa fa-check-circle"></i>  Unlimited replays</li>
      <hr className="line-in" />
      <li><i className="fa fa-check-circle"></i>  Unlimited replays phone</li>
      <hr className="line-in" />
      <li><i className="fa fa-check-circle"></i>  Support via email</li>
    </ul>
  ...
  <div className="pricing-plan pro">
    ...
    <a href="#" className="btn btn-outline-primary" id="btn-pro">Get started</a>
  </div>
  <div className="pricing-plan">
    <h3>Business</h3>
    <hr className="line" />
    ...
    <ul>
      <li><i className="fa fa-check-circle"></i>  Unlimited Live access</li>
      <hr className="line-in" />
      <li><i className="fa fa-check-circle"></i>  Unlimited replays</li>
      <hr className="line-in" />
      <li><i className="fa fa-check-circle"></i>  Priority at supporting</li>
      <hr className="line-in" />
      <li><i className="fa fa-check-circle"></i>  Unlimited content</li>
    </ul>
    <a href="#" className="btn btn-primary">Subscribe Now</a>
  </div>
</div>
